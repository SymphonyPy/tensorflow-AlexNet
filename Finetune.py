...
# test_image('E:/x/2.jpg', 1000, 'caffe_classes.py')
...
def trainModels():
    ...
    display_step = 1
    filewreiter_path = 'filewriter/ships'
    ...
    model = AlexNet(input_x=x, keep_prob=keep_prob, num_classes=num_class, skip_layer=train_layers,
    ...
    with tf.name_scope('train'):
        ...
        train_generator = ImageDataGenerator(class_list=train_file, n_class=num_class, batch_size=batch_size, flip=True,
                                             shuffle=True)
        val_generator = ImageDataGenerator(class_list=val_file, n_class=num_class, batch_size=1, shuffle=False,
                                           flip=False)
